import { shimmer_infinite } from "./animations";

// VitalCardSkeleton: 웹 바이탈 지표 카드의 로딩 스켈레톤
...
// CardSkeleton: 일반 카드의 로딩 스켈레톤
export function CardSkeleton() {
    return (
        <div className={`${shimmer_infinite} relative overflow-hidden rounded-xl bg-gray-100 p-2 shadow-sm`}>
...
// DashboardSkeleton: 대시보드 전체의 로딩 스켈레톤
export default function DashboardSkeleton() {
    return (
        <>
            <div className={`${shimmer_infinite} relative mb-4 h-8 w-36 overflow-hidden rounded-md bg-gray-100`} />
